        ...
        <div className="text-center">
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/10 hover:border-white/30 hover:bg-white/5 text-xs font-mono uppercase tracking-[0.18em] transition-all text-white"
            >
