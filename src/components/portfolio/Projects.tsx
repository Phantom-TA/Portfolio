  ...
  return (
    ...
    >
      ...
      <div className="relative group">
        <div className="relative aspect-[4/3] rounded-2xl overflow-hidden glass noise border border-white/10">
          ...
          <div className="flex gap-3 pt-4">
            {project.links.github && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full border-none ring-1 ring-white/10 hover:ring-white/30 hover:bg-white/5 text-xs font-mono uppercase tracking-[0.18em] transition-all"
              >
